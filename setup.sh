...
export IMAGE_NAME=weather-agent
...
gcloud builds submit \
  ...
  --substitutions=_REGION=${REGION},_RELEASE_TIMESTAMP=${RELEASE_TIMESTAMP},_IMAGE_NAME=${IMAGE_NAME},_REPO_NAME=${REPO_NAME},_API_WEATHER_URL=${API_URL}
